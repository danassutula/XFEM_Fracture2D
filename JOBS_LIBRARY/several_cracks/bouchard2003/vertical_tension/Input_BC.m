...
mFxDim(1,:) = [ 1, 1]; % bottom-left node fully fixed
mFxVal(1,:) = [ 0, 0];

mFxDim(2,:) = [ 0, 1]; % bottom-right node fixed in y
mFxVal(2,:) = [ 0, 0];
...
mBnLod(1,:) = [0,-100]; % bottom edge pulled down
mBnLod(2,:) = [0, 100]; % top edge pulled up
