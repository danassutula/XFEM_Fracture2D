...
vFxBnd = [1,3]; % botton-edge and top-edge
% vFxBnd = [5,6]; % bottom-left and bottom-right nodes
...
vLdBnd = []; % botton-edge and top-edge
...
wCkLod = 1; % with crack pressure
mCkLod(1,:) = [10,0]; % =[p_n,p_t]
