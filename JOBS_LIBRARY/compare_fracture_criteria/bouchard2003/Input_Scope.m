...
with_MeshRead = 1; % 1 - read in , 0 - generate
...
kind_LawDir = jobs_criteria_direction{job_i}; % maxhoop; energy; symmetry;
kind_LawCrt = jobs_criteria_growth{job_i}; % tension; energy; J-int; eliptic; Hayashi; Nuismer;
...
if strcmpi(kind_GrwCrt,'custom')
    ...
    with_GrwCrt_inf = 0.95; % (as fraction of maximum)
end
...
with_GLwDir = jobs_criteria_isImplicit{job_i}; % use energy minimisation to determine crack growth directions
...
plot_VmsContr = 1; % von Mises contours
