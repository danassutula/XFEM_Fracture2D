...
for i = 1:nTp2Up
    ...
    error(['Maximum stress criterion is not implemented correctly. '...
        'Need to maximize k1, but what linearisation to use?'])
    
    vDlBta(i,1) = -2*(k2(i)./k1(i)) * 0.3; % (seems to work okey)
