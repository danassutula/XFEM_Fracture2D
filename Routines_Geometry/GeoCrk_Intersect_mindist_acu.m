function [mNoInc,mCk2Up,cCkCrd,mTpAct,mTpRdi,mCkJun] = GeoCrk_Intersect_mindist_acu ...
    (qCk2Up,mCk2Up,cCkCrd,mTpAct,mTpRdi,mCkJun,nSgBln,f_tip,f_xrs)
%
% Looks for intersections where the crack kink angle is less than pi/2
