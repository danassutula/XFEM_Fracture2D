function [cCkCrd,mTpAct,mTpRdi,mCkJun] = ...
    GeoCrk_Intersect0_mindist(cCkCrd,mTpAct,mTpRdi,mCkJun,f_tip,f_xrs)

% Checks for the FIRST minimum distance intersection that satisfies the
% minimum distance criterion. Then breaks the search and creates the 
% intersection between the tip of crack iCrack with the surface of jCrack
