function [grd_Fe,gd2_Fe] = GrdForceElm_resid_hvi_FD(i_tip,x_crk,...
...
%       GrdForceElm_body_hvi_FD, GrdStiffElm_hvi_FD
...
for i = 1:order+1 % (order+1 == n. samples)
    ...
    [~,dNdX_elm] = ShapesStd_omg(n_gsp,X_gsp); % N_elm
    ...
    Fe{i} = ForceElm_resid(x_elm,dNdX_elm,W_elm,f);
